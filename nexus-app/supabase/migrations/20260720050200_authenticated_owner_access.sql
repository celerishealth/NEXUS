...
CREATE TABLE IF NOT EXISTS public.nexus_authenticated_owner_credentials (
    ...
    CONSTRAINT nexus_authenticated_owner_credentials_membership_fk
        ...
        REFERENCES public.nexus_tenant_owner_membership (
            tenant_id,
            owner_id
        )
        ON DELETE RESTRICT,
...
ON public.nexus_authenticated_owner_credentials (
    tenant_id,
    email_normalized,
    status
);

CREATE TABLE IF NOT EXISTS public.nexus_authenticated_owner_sessions (
    tenant_id VARCHAR(128) NOT NULL,
...
ON public.nexus_authenticated_owner_sessions (
    tenant_id,
    session_digest,
    expires_at
)
...
ALTER TABLE public.nexus_authenticated_owner_credentials
...
ALTER TABLE public.nexus_authenticated_owner_sessions
    ENABLE ROW LEVEL SECURITY;
...
REVOKE ALL
ON TABLE public.nexus_authenticated_owner_sessions
FROM public, anon, authenticated, service_role;
