...
import { getControlledPaidPilotSubscriptionLockBoundaryFinalPhaseCompletionSummary } from "@/lib/nexus/controlledPaidPilotSubscriptionLockBoundaryFinalPhaseCompletionSummary";
...
export async function GET() {
  return NextResponse.json({
    ok: true,
    route:
      "controlled-paid-pilot-subscription-lock-boundary-final-phase-completion-summary-preview-only",
    safety:
    ...
    data: getControlledPaidPilotSubscriptionLockBoundaryFinalPhaseCompletionSummary(),
  });
}
