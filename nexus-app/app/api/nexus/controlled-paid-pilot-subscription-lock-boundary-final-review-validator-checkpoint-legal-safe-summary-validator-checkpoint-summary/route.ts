...
import {
  getControlledPaidPilotSubscriptionLockBoundaryFinalReviewValidatorCheckpointLegalSafeSummaryValidatorCheckpointSummary,
...
} from "@/lib/nexus/controlledPaidPilotSubscriptionLockBoundaryFinalReviewValidatorCheckpointLegalSafeSummaryValidatorCheckpointSummary";
...
export async function GET() {
  ...
  return NextResponse.json({
    ok: validation.ok,
    route:
      "controlled-paid-pilot-subscription-lock-boundary-final-review-validator-checkpoint-legal-safe-summary-validator-checkpoint-summary-preview-only",
    safety: {
      readOnly: true,
      previewOnly: true,
