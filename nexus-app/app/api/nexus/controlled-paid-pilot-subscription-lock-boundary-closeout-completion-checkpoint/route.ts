...
import { getControlledPaidPilotSubscriptionLockBoundaryCloseoutCompletionCheckpoint } from "@/lib/nexus/controlledPaidPilotSubscriptionLockBoundaryCloseoutCompletionCheckpoint";
...
export async function GET() {
  return NextResponse.json({
    ok: true,
    route:
      "controlled-paid-pilot-subscription-lock-boundary-closeout-completion-checkpoint-preview-only",
    safety:
    ...
    data: getControlledPaidPilotSubscriptionLockBoundaryCloseoutCompletionCheckpoint(),
  });
}
