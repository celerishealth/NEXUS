...
import { getControlledPaidPilotSubscriptionLockBoundaryCloseoutCheckpoint } from "@/lib/nexus/controlledPaidPilotSubscriptionLockBoundaryCloseoutCheckpoint";
...
export async function GET() {
  return NextResponse.json({
    ok: true,
    route:
      "controlled-paid-pilot-subscription-lock-boundary-closeout-checkpoint-preview-only",
    safety:
    ...
    data: getControlledPaidPilotSubscriptionLockBoundaryCloseoutCheckpoint(),
  });
}
