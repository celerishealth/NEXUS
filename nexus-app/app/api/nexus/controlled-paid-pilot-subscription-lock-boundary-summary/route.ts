...
import { getControlledPaidPilotSubscriptionLockBoundarySummary } from "@/lib/nexus/controlledPaidPilotSubscriptionLockBoundarySummary";
...
export async function GET() {
  return NextResponse.json({
    ok: true,
    route:
      "controlled-paid-pilot-subscription-lock-boundary-summary-preview-only",
    safety:
    ...
    data: getControlledPaidPilotSubscriptionLockBoundarySummary(),
  });
}
