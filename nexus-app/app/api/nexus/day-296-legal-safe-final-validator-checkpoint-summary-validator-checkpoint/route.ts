...
import {
  getNexusDay296LegalSafeFinalValidatorCheckpointSummaryValidatorCheckpoint,
  validateNexusDay296LegalSafeFinalValidatorCheckpointSummaryValidatorCheckpoint
} from "@/lib/nexus/day296LegalSafeFinalValidatorCheckpointSummaryValidatorCheckpoint";
...
export async function GET() {
  ...
  return NextResponse.json({
    ok: validation.ok,
    route: "day-296-legal-safe-final-validator-checkpoint-summary-validator-checkpoint-preview-only",
    safety: {
      readOnly: true,
      previewOnly: true,
