...
import { getControlledPaidPilotSubscriptionLockBoundaryCloseoutCompletionFinalReview } from "@/lib/nexus/controlledPaidPilotSubscriptionLockBoundaryCloseoutCompletionFinalReview";
...
export async function GET() {
  return NextResponse.json({
    ok: true,
    route:
      "controlled-paid-pilot-subscription-lock-boundary-closeout-completion-final-review-preview-only",
    safety:
    ...
    data: getControlledPaidPilotSubscriptionLockBoundaryCloseoutCompletionFinalReview(),
  });
}
