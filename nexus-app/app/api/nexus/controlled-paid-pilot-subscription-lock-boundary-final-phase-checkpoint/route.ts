...
import { getControlledPaidPilotSubscriptionLockBoundaryFinalPhaseCheckpoint } from "@/lib/nexus/controlledPaidPilotSubscriptionLockBoundaryFinalPhaseCheckpoint";
...
export async function GET() {
  return NextResponse.json({
    ok: true,
    route:
      "controlled-paid-pilot-subscription-lock-boundary-final-phase-checkpoint-preview-only",
    safety:
    ...
    data: getControlledPaidPilotSubscriptionLockBoundaryFinalPhaseCheckpoint(),
  });
}
