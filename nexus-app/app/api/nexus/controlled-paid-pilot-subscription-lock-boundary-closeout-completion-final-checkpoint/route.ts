...
import { getControlledPaidPilotSubscriptionLockBoundaryCloseoutCompletionFinalCheckpoint } from "@/lib/nexus/controlledPaidPilotSubscriptionLockBoundaryCloseoutCompletionFinalCheckpoint";
...
export async function GET() {
  return NextResponse.json({
    ok: true,
    route:
      "controlled-paid-pilot-subscription-lock-boundary-closeout-completion-final-checkpoint-preview-only",
    safety:
    ...
    data: getControlledPaidPilotSubscriptionLockBoundaryCloseoutCompletionFinalCheckpoint(),
  });
}
