...
import { getControlledPaidPilotSubscriptionLockBoundaryFinalPhaseFinalReview } from "@/lib/nexus/controlledPaidPilotSubscriptionLockBoundaryFinalPhaseFinalReview";
...
export async function GET() {
  return NextResponse.json({
    ok: true,
    route:
      "controlled-paid-pilot-subscription-lock-boundary-final-phase-final-review-preview-only",
    safety:
    ...
    data: getControlledPaidPilotSubscriptionLockBoundaryFinalPhaseFinalReview(),
  });
}
