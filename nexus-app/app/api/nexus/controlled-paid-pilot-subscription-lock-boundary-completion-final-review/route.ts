...
import { getControlledPaidPilotSubscriptionLockBoundaryCompletionFinalReview } from "@/lib/nexus/controlledPaidPilotSubscriptionLockBoundaryCompletionFinalReview";
...
export async function GET() {
  return NextResponse.json({
    ok: true,
    route:
      "controlled-paid-pilot-subscription-lock-boundary-completion-final-review-preview-only",
    safety:
    ...
    data: getControlledPaidPilotSubscriptionLockBoundaryCompletionFinalReview(),
  });
}
