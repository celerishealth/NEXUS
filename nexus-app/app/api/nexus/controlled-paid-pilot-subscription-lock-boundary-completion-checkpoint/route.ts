...
import { getControlledPaidPilotSubscriptionLockBoundaryCompletionCheckpoint } from "@/lib/nexus/controlledPaidPilotSubscriptionLockBoundaryCompletionCheckpoint";
...
export async function GET() {
  return NextResponse.json({
    ok: true,
    route:
      "controlled-paid-pilot-subscription-lock-boundary-completion-checkpoint-preview-only",
    safety:
    ...
    data: getControlledPaidPilotSubscriptionLockBoundaryCompletionCheckpoint(),
  });
}
