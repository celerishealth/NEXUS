...
import { validateControlledPaidPilotSubscriptionLockBoundaryFinalPhaseSummary } from "@/lib/nexus/controlledPaidPilotSubscriptionLockBoundaryFinalPhaseValidator";
...
export async function GET() {
  return NextResponse.json({
    ok: true,
    route:
      "controlled-paid-pilot-subscription-lock-boundary-final-phase-validator-preview-only",
    safety:
    ...
    data: validateControlledPaidPilotSubscriptionLockBoundaryFinalPhaseSummary(),
  });
}
