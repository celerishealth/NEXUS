...
import {
  getControlledPaidPilotSubscriptionLockBoundaryFinalReviewValidatorCheckpointCompletionSummary,
  validateControlledPaidPilotSubscriptionLockBoundaryFinalReviewValidatorCheckpointCompletionSummary
} from "@/lib/nexus/controlledPaidPilotSubscriptionLockBoundaryFinalReviewValidatorCheckpointCompletionSummary";
...
export async function GET() {
  ...
  return NextResponse.json({
    ok: validation.ok,
    route:
      "controlled-paid-pilot-subscription-lock-boundary-final-review-validator-checkpoint-completion-summary-preview-only",
    safety: {
      readOnly: true,
      previewOnly: true,
