...
import { getControlledPaidPilotSubscriptionLockBoundaryCloseoutFinalReview } from "@/lib/nexus/controlledPaidPilotSubscriptionLockBoundaryCloseoutFinalReview";
...
export async function GET() {
  return NextResponse.json({
    ok: true,
    route:
      "controlled-paid-pilot-subscription-lock-boundary-closeout-final-review-preview-only",
    safety:
    ...
    data: getControlledPaidPilotSubscriptionLockBoundaryCloseoutFinalReview(),
  });
}
