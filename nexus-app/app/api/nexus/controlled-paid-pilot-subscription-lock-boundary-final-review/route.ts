...
import { getControlledPaidPilotSubscriptionLockBoundaryFinalReview } from "@/lib/nexus/controlledPaidPilotSubscriptionLockBoundaryFinalReview";
...
export async function GET() {
  return NextResponse.json({
    ok: true,
    route:
      "controlled-paid-pilot-subscription-lock-boundary-final-review-preview-only",
    safety:
    ...
    data: getControlledPaidPilotSubscriptionLockBoundaryFinalReview(),
  });
}
