...
import { getControlledPaidPilotSubscriptionLockBoundaryFinalCheckpoint } from "@/lib/nexus/controlledPaidPilotSubscriptionLockBoundaryFinalCheckpoint";
...
export async function GET() {
  return NextResponse.json({
    ok: true,
    route:
      "controlled-paid-pilot-subscription-lock-boundary-final-checkpoint-preview-only",
    safety:
    ...
    data: getControlledPaidPilotSubscriptionLockBoundaryFinalCheckpoint(),
  });
}
