...
import {
  getControlledPaidPilotSubscriptionLockBoundaryFinalReviewValidatorCheckpointLegalSafeSummaryFinalReview,
  validateControlledPaidPilotSubscriptionLockBoundaryFinalReviewValidatorCheckpointLegalSafeSummaryFinalReview
} from "@/lib/nexus/controlledPaidPilotSubscriptionLockBoundaryFinalReviewValidatorCheckpointLegalSafeSummaryFinalReview";
...
export async function GET() {
  ...
  return NextResponse.json({
    ok: validation.ok,
    route:
      "controlled-paid-pilot-subscription-lock-boundary-final-review-validator-checkpoint-legal-safe-summary-final-review-preview-only",
    safety: {
      readOnly: true,
      previewOnly: true,
