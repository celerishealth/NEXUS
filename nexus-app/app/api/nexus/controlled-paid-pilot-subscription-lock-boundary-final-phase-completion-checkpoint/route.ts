...
import { getControlledPaidPilotSubscriptionLockBoundaryFinalPhaseCompletionCheckpoint } from "@/lib/nexus/controlledPaidPilotSubscriptionLockBoundaryFinalPhaseCompletionCheckpoint";
...
export async function GET() {
  return NextResponse.json({
    ok: true,
    route:
      "controlled-paid-pilot-subscription-lock-boundary-final-phase-completion-checkpoint-preview-only",
    safety:
    ...
    data: getControlledPaidPilotSubscriptionLockBoundaryFinalPhaseCompletionCheckpoint(),
  });
}
