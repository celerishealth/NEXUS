...
import { getControlledPaidPilotSubscriptionLockBoundaryCompletionFinalCheckpoint } from "@/lib/nexus/controlledPaidPilotSubscriptionLockBoundaryCompletionFinalCheckpoint";
...
export async function GET() {
  return NextResponse.json({
    ok: true,
    route:
      "controlled-paid-pilot-subscription-lock-boundary-completion-final-checkpoint-preview-only",
    safety:
    ...
    data: getControlledPaidPilotSubscriptionLockBoundaryCompletionFinalCheckpoint(),
  });
}
