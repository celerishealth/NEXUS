...
import { getControlledPaidPilotLaunchReadinessGate } from "@/lib/nexus/controlledPaidPilotLaunchReadinessGate";
...
export async function GET() {
  return NextResponse.json({
    ok: true,
    route: "controlled-paid-pilot-launch-readiness-gate-preview-only",
    readinessGate: getControlledPaidPilotLaunchReadinessGate(),
    safety: {
      readOnly: true,
      previewOnly: true,
