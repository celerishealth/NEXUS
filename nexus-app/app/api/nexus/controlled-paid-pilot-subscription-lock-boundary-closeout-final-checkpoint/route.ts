...
import { getControlledPaidPilotSubscriptionLockBoundaryCloseoutFinalCheckpoint } from "@/lib/nexus/controlledPaidPilotSubscriptionLockBoundaryCloseoutFinalCheckpoint";
...
export async function GET() {
  return NextResponse.json({
    ok: true,
    route:
      "controlled-paid-pilot-subscription-lock-boundary-closeout-final-checkpoint-preview-only",
    safety:
    ...
    data: getControlledPaidPilotSubscriptionLockBoundaryCloseoutFinalCheckpoint(),
  });
}
