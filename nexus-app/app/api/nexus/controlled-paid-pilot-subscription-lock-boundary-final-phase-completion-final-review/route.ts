...
import { getControlledPaidPilotSubscriptionLockBoundaryFinalPhaseCompletionFinalReview } from "@/lib/nexus/controlledPaidPilotSubscriptionLockBoundaryFinalPhaseCompletionFinalReview";
...
export async function GET() {
  return NextResponse.json({
    ok: true,
    route:
      "controlled-paid-pilot-subscription-lock-boundary-final-phase-completion-final-review-preview-only",
    safety:
    ...
    data: getControlledPaidPilotSubscriptionLockBoundaryFinalPhaseCompletionFinalReview(),
  });
}
