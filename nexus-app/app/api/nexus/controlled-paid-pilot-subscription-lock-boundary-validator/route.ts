...
import { validateControlledPaidPilotSubscriptionLockBoundary } from "@/lib/nexus/controlledPaidPilotSubscriptionLockBoundaryValidator";
...
export async function GET() {
  return NextResponse.json({
    ok: true,
    route:
      "controlled-paid-pilot-subscription-lock-boundary-validator-preview-only",
    safety:
    ...
    data: validateControlledPaidPilotSubscriptionLockBoundary(),
  });
}
