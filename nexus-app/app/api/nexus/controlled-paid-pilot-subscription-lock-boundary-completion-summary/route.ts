...
import { getControlledPaidPilotSubscriptionLockBoundaryCompletionSummary } from "@/lib/nexus/controlledPaidPilotSubscriptionLockBoundaryCompletionSummary";
...
export async function GET() {
  return NextResponse.json({
    ok: true,
    route:
      "controlled-paid-pilot-subscription-lock-boundary-completion-summary-preview-only",
    safety:
    ...
    data: getControlledPaidPilotSubscriptionLockBoundaryCompletionSummary(),
  });
}
