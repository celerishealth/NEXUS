...
import {
  getControlledPaidPilotSubscriptionLockBoundaryFinalReviewValidatorCheckpointLegalSafeSummaryValidatorCheckpointSummaryValidator,
...
} from "@/lib/nexus/controlledPaidPilotSubscriptionLockBoundaryFinalReviewValidatorCheckpointLegalSafeSummaryValidatorCheckpointSummaryValidator";
...
export async function GET() {
  ...
  return NextResponse.json({
    ok: validation.ok,
    route:
      "controlled-paid-pilot-subscription-lock-boundary-final-review-validator-checkpoint-legal-safe-summary-validator-checkpoint-summary-validator-preview-only",
    safety: {
      readOnly: true,
      previewOnly: true,
