...
import { getControlledPaidPilotSubscriptionLockBoundaryFinalCompletionCloseout } from "@/lib/nexus/controlledPaidPilotSubscriptionLockBoundaryFinalCompletionCloseout";
...
export async function GET() {
  return NextResponse.json({
    ok: true,
    route:
      "controlled-paid-pilot-subscription-lock-boundary-final-completion-closeout-preview-only",
    safety:
    ...
    data: getControlledPaidPilotSubscriptionLockBoundaryFinalCompletionCloseout(),
  });
}
