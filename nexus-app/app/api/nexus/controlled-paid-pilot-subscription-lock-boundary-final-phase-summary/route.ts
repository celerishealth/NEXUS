...
import { getControlledPaidPilotSubscriptionLockBoundaryFinalPhaseSummary } from "@/lib/nexus/controlledPaidPilotSubscriptionLockBoundaryFinalPhaseSummary";
...
export async function GET() {
  return NextResponse.json({
    ok: true,
    route:
      "controlled-paid-pilot-subscription-lock-boundary-final-phase-summary-preview-only",
    safety:
    ...
    data: getControlledPaidPilotSubscriptionLockBoundaryFinalPhaseSummary(),
  });
}
