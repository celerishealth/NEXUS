...
import { getControlledPaidPilotSubscriptionLockBoundaryFinalPhaseFinalCheckpoint } from "@/lib/nexus/controlledPaidPilotSubscriptionLockBoundaryFinalPhaseFinalCheckpoint";
...
export async function GET() {
  return NextResponse.json({
    ok: true,
    route:
      "controlled-paid-pilot-subscription-lock-boundary-final-phase-final-checkpoint-preview-only",
    safety:
    ...
    data: getControlledPaidPilotSubscriptionLockBoundaryFinalPhaseFinalCheckpoint(),
  });
}
