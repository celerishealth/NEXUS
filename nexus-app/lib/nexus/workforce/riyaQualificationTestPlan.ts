...
import {
  ...
  type RiyaQualificationTestingAdmission,
} from "./riyaQualificationTestingAdmission";

export const RIYA_QUALIFICATION_TEST_PLAN_VERSION =
  "nexus-riya-qualification-test-plan-v1" as const;

export interface CreateRiyaQualificationTestPlanInput {
...
export interface RiyaQualificationPlannedCase {
...
export interface RiyaQualificationTestPlan {
  readonly version:
    typeof RIYA_QUALIFICATION_TEST_PLAN_VERSION;
  ...
  readonly plannedCases:
    readonly RiyaQualificationPlannedCase[];
...
function canonicalize(
  ...
  throw new Error(
    "Unsupported deterministic Riya qualification-plan value.",
  );
}
...
function requireIsoTimestamp(
  ...
  if (
    ...
    throw new Error(
      "Riya qualification-plan time must be an exact ISO timestamp.",
    );
  }
}

export function createRiyaQualificationTestPlan(
  input:
    CreateRiyaQualificationTestPlanInput,
): RiyaQualificationTestPlan {
  requireIdentifier(
    "Riya qualification planId",
    input.planId,
  );

  requireIdentifier(
    "Riya qualification tenantId",
    input.tenantId,
  );

  requireIdentifier(
    "Riya qualification ownerId",
    input.ownerId,
  );
  ...
  if (
    ...
    throw new Error(
      "Riya qualification-plan identity is invalid.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Cross-tenant Riya qualification planning is blocked.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Only the admission-bound owner can prepare the Riya qualification plan.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Riya qualification admission is not eligible for test planning.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Riya qualification plan must contain exactly 12 unique canonical cases.",
    );
  }

  const planCore = {
    version:
      RIYA_QUALIFICATION_TEST_PLAN_VERSION,
...
export function validateRiyaQualificationTestPlan(
  plan:
    RiyaQualificationTestPlan,
): void {
  if (
    ...
    throw new Error(
      "Riya qualification test plan identity is invalid.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Riya qualification plan canonical cases are invalid.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Riya qualification planned-case boundary is invalid.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Riya qualification plan source evidence is invalid.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Riya qualification testing policy is invalid.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Riya qualification plan authority boundary is invalid.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Riya qualification test plan integrity is invalid.",
    );
  }
}