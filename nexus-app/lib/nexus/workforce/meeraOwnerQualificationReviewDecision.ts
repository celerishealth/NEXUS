...
import {
  ...
  type MeeraQualificationReadinessAssessment,
} from "./meeraQualificationReadinessAssessment";

export const MEERA_OWNER_QUALIFICATION_REVIEW_DECISION_VERSION =
  "nexus-meera-owner-qualification-review-decision-v1" as const;

export const MEERA_OWNER_QUALIFICATION_REVIEW_DECISIONS =
  [
    "APPROVE_FORMAL_QUALIFICATION_TESTING",
    "REJECT_FORMAL_QUALIFICATION_TESTING",
  ] as const;

export type MeeraOwnerQualificationReviewDecisionValue =
  (typeof MEERA_OWNER_QUALIFICATION_REVIEW_DECISIONS)[number];

export interface CreateMeeraOwnerQualificationReviewDecisionInput {
  ...
  readonly decision:
    MeeraOwnerQualificationReviewDecisionValue;

  readonly rationale: string;
  readonly decidedAt: string;
}

export interface MeeraOwnerQualificationReviewDecision {
  readonly version:
    typeof MEERA_OWNER_QUALIFICATION_REVIEW_DECISION_VERSION;
...
function canonicalize(
  ...
  throw new Error(
    "Unsupported deterministic Meera owner-review value.",
  );
}
...
function requireIsoTimestamp(
  ...
  if (
    ...
    throw new Error(
      "Meera owner-review decision time must be an exact ISO timestamp.",
    );
  }
}
...
function requireRationale(
  ...
  if (
    ...
    throw new Error(
      "Meera owner-review rationale is invalid.",
    );
  }
...
export function createMeeraOwnerQualificationReviewDecision(
  input:
    CreateMeeraOwnerQualificationReviewDecisionInput,
): MeeraOwnerQualificationReviewDecision {
  requireIdentifier(
    "Meera decisionId",
    input.decisionId,
  );
  ...
  if (
    ...
    throw new Error(
      "Meera readiness assessment is not reviewable.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Meera owner-review employee identity is invalid.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Cross-tenant Meera qualification review is blocked.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Only the readiness-bound owner can review Meera qualification.",
    );
  }

  if (
    !MEERA_OWNER_QUALIFICATION_REVIEW_DECISIONS.includes(
      input.decision,
    )
  ) {
    throw new Error(
      "Meera owner qualification decision is invalid.",
    );
  }
  ...
  const decisionCore = {
    version:
      MEERA_OWNER_QUALIFICATION_REVIEW_DECISION_VERSION,
...
export function validateMeeraOwnerQualificationReviewDecision(
  decision:
    MeeraOwnerQualificationReviewDecision,
): void {
  if (
    ...
    throw new Error(
      "Meera owner qualification review identity is invalid.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Meera owner qualification review outcome is invalid.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Meera readiness digest is invalid.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Meera owner qualification review integrity is invalid.",
    );
  }
}
