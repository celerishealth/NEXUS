...
import {
  ...
  type MeeraOwnerQualificationReviewDecision,
} from "./meeraOwnerQualificationReviewDecision";

export const MEERA_QUALIFICATION_TESTING_ADMISSION_VERSION =
  "nexus-meera-qualification-testing-admission-v1" as const;

export interface CreateMeeraQualificationTestingAdmissionInput {
...
export interface MeeraQualificationTestingAdmission {
  readonly version:
    typeof MEERA_QUALIFICATION_TESTING_ADMISSION_VERSION;
...
function canonicalize(
  ...
  throw new Error(
    "Unsupported deterministic Meera testing-admission value.",
  );
}
...
function requireIsoTimestamp(
  ...
  if (
    ...
    throw new Error(
      "Meera testing-admission preparation time must be an exact ISO timestamp.",
    );
  }
}

export function createMeeraQualificationTestingAdmission(
  input:
    CreateMeeraQualificationTestingAdmissionInput,
  ...
  if (
    ...
    throw new Error(
      "Meera testing-admission identity is invalid.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Cross-tenant Meera testing admission is blocked.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Only the decision-bound owner can admit Meera qualification testing.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Rejected Meera qualification review cannot create testing admission.",
    );
  }

  const admissionCore = {
    version:
      MEERA_QUALIFICATION_TESTING_ADMISSION_VERSION,
...
export function validateMeeraQualificationTestingAdmission(
  admission:
    MeeraQualificationTestingAdmission,
): void {
  if (
    ...
    throw new Error(
      "Meera qualification testing admission is invalid.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Meera qualification testing admission evidence is invalid.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Meera qualification testing admission integrity is invalid.",
    );
  }
}
