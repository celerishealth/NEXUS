...
export const RIYA_QUALIFIED_EMPLOYEE_MANIFEST_ISSUANCE_VERSION =
  "nexus-riya-qualified-employee-manifest-issuance-v1" as const;

export interface CreateRiyaQualifiedEmployeeManifestIssuanceInput {
...
export interface RiyaQualifiedEmployeeManifestIssuance {
  readonly version:
    typeof RIYA_QUALIFIED_EMPLOYEE_MANIFEST_ISSUANCE_VERSION;
...
function stableStringify(
  ...
  if (primitive === undefined) {
    throw new Error(
      "Unsupported deterministic Riya qualified-manifest value.",
    );
  }
...
function resolveCanonicalRiyaTemplate(
  ...
  if (template === undefined) {
    throw new Error(
      "Canonical registered Riya template was not found.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Canonical registered Riya template identity is invalid.",
    );
  }
...
function validateQualificationEvidence(
  ...
  if (
    ...
    throw new Error(
      "Riya requires an owner-approved 100/100 passing qualification.",
    );
  }
  ...
  for (
    ...
    if (
      ...
      throw new Error(
        `Riya qualification category ${category} is not exact.`,
      );
    }
  ...
  if (
    ...
    throw new Error(
      "Riya qualification category totals do not match the report total.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Riya qualification safety boundary has been changed.",
    );
  }
}
...
function validateFormalQualification(
  input:
    CreateRiyaQualifiedEmployeeManifestIssuanceInput,
  ...
  if (
    ...
    throw new Error(
      "A valid Workforce Day 52 Riya formal qualification issuance is required.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Cross-tenant Riya qualified manifest creation is blocked.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Only the qualification-bound owner can create Riya's qualified manifest.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Riya formal qualification does not belong to the canonical registered template at the evidence-bound registry creation time.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Workforce Day 52 Riya qualification summary is incomplete.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Workforce Day 52 Riya authority boundary has been changed.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Riya formal qualification time does not match its qualification report.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Riya source registry cannot be created after formal qualification.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Riya qualified manifest creation cannot precede formal qualification.",
    );
  }
}
...
function validatePreservedManifest(
  ...
  if (
    ...
    throw new Error(
      "Qualified manifest changed Riya's registered identity or role.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Qualified manifest changed Riya's registered operating contract.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Qualified Riya manifest evaluation does not match the qualification report.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Qualified Riya manifest safety boundary has been changed.",
    );
  }
}

export function validateRiyaQualifiedEmployeeManifestIssuance(
  issuance:
    RiyaQualifiedEmployeeManifestIssuance,
): void {
  if (
    issuance.version !==
      RIYA_QUALIFIED_EMPLOYEE_MANIFEST_ISSUANCE_VERSION ||
    ...
    throw new Error(
      "Riya qualified employee manifest issuance identity is invalid.",
    );
  }
  ...
  requireIsoTimestamp(
    "Riya qualified manifest creation time",
    issuance.createdAt,
  );
  ...
  if (
    ...
    throw new Error(
      "Riya qualified manifest record is invalid.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Riya qualified manifest authority boundary is invalid.",
    );
  }
...
export function createRiyaQualifiedEmployeeManifestIssuance(
  input:
    CreateRiyaQualifiedEmployeeManifestIssuanceInput,
): RiyaQualifiedEmployeeManifestIssuance {
  requireIdentifier(
    "Riya qualified manifest issuanceId",
    input.manifestIssuanceId,
  );

  requireIdentifier(
    "Riya qualified manifest tenantId",
    input.tenantId,
  );

  requireIdentifier(
    "Riya qualified manifest ownerId",
    input.ownerId,
  );
  ...
  const issuance =
    deepFreeze({
      ...
      manifestIssuanceDigest:
        sha256(issuanceCore),
    }) as RiyaQualifiedEmployeeManifestIssuance;
