...
export const RIYA_ACTIVATION_CANDIDATE_ISSUANCE_VERSION =
  "nexus-riya-activation-candidate-issuance-v1" as const;

export interface CreateRiyaActivationCandidateIssuanceInput {
...
export interface RiyaActivationCandidateIssuance {
  readonly version:
    typeof RIYA_ACTIVATION_CANDIDATE_ISSUANCE_VERSION;
...
function stableStringify(
  ...
  if (primitive === undefined) {
    throw new Error(
      "Unsupported deterministic Riya activation-candidate value.",
    );
  }
...
function validateQualifiedManifestBinding(
  input:
    CreateRiyaActivationCandidateIssuanceInput,
): void {
  const source =
  ...
  if (
    ...
    throw new Error(
      "Only the qualified-manifest-bound owner can prepare Riya's activation candidate.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Workforce Day 53 Riya authority boundary has been changed.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Riya activation candidate cannot precede qualified manifest issuance.",
    );
  }
}
...
function validateFormalQualificationBinding(
  ...
  if (
    ...
    throw new Error(
      "Riya formal qualification is not bound to the qualified manifest issuance.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Cross-tenant Riya formal qualification binding is blocked.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Riya formal qualification owner binding is invalid.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Riya formal qualification belongs to a different AI employee.",
    );
  }
}
...
function validateCanonicalTemplateBinding(
  ...
  if (
    ...
    throw new Error(
      "Canonical Riya template binding verification failed.",
    );
  }
}
...
function validateActivationCandidate(
  ...
  if (
    ...
    throw new Error(
      "Riya activation candidate binding verification failed.",
    );
  }

  requireDigest(
    "Riya activation candidate digest",
  ...
  if (
    ...
    throw new Error(
      "Riya activation candidate runtime must remain paused for owner activation.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Riya activation candidate safety boundary has been changed.",
    );
  }
}

export function validateRiyaActivationCandidateIssuance(
  issuance:
    RiyaActivationCandidateIssuance,
): void {
  if (
    issuance.version !==
      RIYA_ACTIVATION_CANDIDATE_ISSUANCE_VERSION ||
    ...
    throw new Error(
      "Riya activation candidate issuance identity is invalid.",
    );
  }
  ...
  requireIsoTimestamp(
    "Riya activation candidate preparation time",
    issuance.preparedAt,
  );
  ...
  if (
    ...
    throw new Error(
      "Riya activation candidate authority boundary is invalid.",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Riya activation candidate issuance integrity is invalid.",
    );
  }
}

export function createRiyaActivationCandidateIssuance(
  input:
    CreateRiyaActivationCandidateIssuanceInput,
): RiyaActivationCandidateIssuance {
  requireIdentifier(
    "Riya activation candidate issuanceId",
    input.activationCandidateIssuanceId,
  );

  requireIdentifier(
    "Riya activation candidate runtimeId",
    input.runtimeId,
  );

  requireIdentifier(
    "Riya activation candidate tenantId",
    input.tenantId,
  );

  requireIdentifier(
    "Riya activation candidate ownerId",
    input.ownerId,
  );
  ...
  const issuance =
    deepFreeze({
      ...
      activationCandidateIssuanceDigest:
        sha256(issuanceCore),
    }) as RiyaActivationCandidateIssuance;
