...
describe(
  "Riya owner limited internal pilot recommendation three execution decision",
  () => {
    it(
      "approves recommendation three execution without performing it",
      async () => {
        const decision =
          createRiyaOwnerLimitedInternalPilotRecommendationThreeExecutionDecision(
    ...
    it(
      "records rejection and retains recommendation three preparation only",
      async () => {
        const decision =
          createRiyaOwnerLimitedInternalPilotRecommendationThreeExecutionDecision(
            await day69DecisionInput({
              decisionId:
                "riya-owner-recommendation-three-execution-rejected-day-69",

              decision:
                "REJECT_AND_RETAIN_RECOMMENDATION_THREE_PREPARATION_ONLY",

              reason:
                "Owner rejected execution and retained recommendation three at preparation only.",
            }),
          );
    ...
    it(
      "binds exact Day 68 preparation and complete source identity chain",
      async () => {
        const input =
          await day69DecisionInput();
    ...
    it(
      "preserves exact final options tradeoff recommendation scope",
      async () => {
        const decision =
          createRiyaOwnerLimitedInternalPilotRecommendationThreeExecutionDecision(
            await day69DecisionInput(),
      ...
      async () => {
        ...
        expect(() =>
          createRiyaOwnerLimitedInternalPilotRecommendationThreeExecutionDecision({
            ...
            decision:
              "INVALID_EXECUTION_DECISION" as Day69DecisionInput[
                "decision"
              ],
          }),
        ).toThrow(
      ...
      async () => {
        ...
        expect(() =>
          createRiyaOwnerLimitedInternalPilotRecommendationThreeExecutionDecision({
            ...
            decisionId:
              "secret-riya-recommendation-three-execution-decision",
          }),
        ).toThrow(
