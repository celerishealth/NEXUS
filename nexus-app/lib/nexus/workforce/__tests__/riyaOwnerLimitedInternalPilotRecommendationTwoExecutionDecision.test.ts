...
describe(
  "Riya owner limited internal pilot recommendation two execution decision",
  () => {
    it(
      "approves recommendation two execution without performing it",
      async () => {
        const decision =
          createRiyaOwnerLimitedInternalPilotRecommendationTwoExecutionDecision(
    ...
    it(
      "records rejection and retains recommendation two preparation only",
      async () => {
        const decision =
          createRiyaOwnerLimitedInternalPilotRecommendationTwoExecutionDecision(
            await day65DecisionInput({
              decisionId:
                "riya-owner-recommendation-two-execution-rejected-day-65",

              decision:
                "REJECT_AND_RETAIN_RECOMMENDATION_TWO_PREPARATION_ONLY",

              reason:
                "Owner rejected execution and retained recommendation two at preparation only.",
            }),
          );
    ...
    it(
      "binds exact Day 64 preparation and complete source chain",
      async () => {
        const input =
          await day65DecisionInput();
    ...
    it(
      "preserves exact recommendation two clarification scope",
      async () => {
        const decision =
          createRiyaOwnerLimitedInternalPilotRecommendationTwoExecutionDecision(
            await day65DecisionInput(),
      ...
      async () => {
        ...
        expect(() =>
          createRiyaOwnerLimitedInternalPilotRecommendationTwoExecutionDecision({
            ...
            decision:
              "INVALID_EXECUTION_DECISION" as Day65DecisionInput[
                "decision"
              ],
          }),
        ).toThrow(
      ...
      async () => {
        ...
        expect(() =>
          createRiyaOwnerLimitedInternalPilotRecommendationTwoExecutionDecision({
            ...
            decisionId:
              "secret-riya-recommendation-two-execution-decision",
          }),
        ).toThrow(
